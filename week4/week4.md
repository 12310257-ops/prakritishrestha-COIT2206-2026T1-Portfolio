...
### Host1 Configuration
![Task 1 Host1 Configuration](hostt2.png)


![Task 1 Host2 Configuration](host3.png)
...
![Task 2 OSPF Neighbor](frr1-2checkospf.png)

### IP Route Table
This shows the routes installed in the router forwarding table.

![Task 2 IP Route](iprouteospfneighbor.png)
...
![Task  Traceroute After](afterresult.png)
